...
class Parser {
    ...
    private:
        ...
        bool compatibleTypeCheckCodeGen(Symbol &dest, Symbol &exp);
        bool arrayOpTypeCheckCodeGen(Symbol &lhs, Symbol &rhs, Token &op);
        void arrayAssignmentCodeGen(Symbol &dest, Symbol &exp);
